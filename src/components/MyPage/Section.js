...
const Section = ({ title }) => {
  const icon =
    title === '먹어 볼래'
      ? require('public/icons/tab_challenge.png')
      : title === '내가 쓴 리스트'
      ? require('public/icons/tab_mylist.png')
      : title === '다녀 온 가게'
      ? require('public/icons/tab_visited.png')
      : require('public/icons/tab_setting.png');
